                            ...
                            <div class="as-producttile-info" style="float:left;min-height: 168px;">
                                <div class="as-producttile-titlepricewraper" style="min-height: 128px;">
                                    <form action="process.php" method="POST">
                                        ...
                                        <script src="https://www.mercadopago.com.mx/integrations/v1/web-tokenize-checkout.js"data-public-key="TEST-151a7d2e-e1b3-4a16-bb5f-97519ec58d17"data-transaction-amount="<?php echo $_POST['price']; ?>" data-button-label="Pagar con mercadoPago"></script>
                                    </form>
